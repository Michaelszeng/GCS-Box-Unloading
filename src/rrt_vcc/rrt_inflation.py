...
pickle_file = f'{TEST_SCENE}_endpts_backup2.pkl'
...
IrisRegionGenerator.visualize_iris_region(plant, plant_context, cspace_meshcat if ambient_dim == 3 else meshcat, rrt_inflation_regions, name="rrt_inflation_regions", task_space=(ambient_dim!=3), scene=TEST_SCENE)

coverage = IrisRegionGenerator.estimate_coverage(plant, cspace_obstacle_collision_checker, rrt_inflation_regions)
IrisRegionGenerator.visualize_connectivity(rrt_inflation_regions, coverage, output_file='rrt_vcc_inflation_connectivity.svg', skip_svg=False)
